...
import {_updateLockfileDependencies} from "#~src/internal/_updateLockfileDependencies.mts"
...
function makeReturnObject(
	...
	return {
		...
		async updateLockfileDependencies(dependencies) {
			return await _updateLockfileDependencies(projectRoot, dependencies)
		},
